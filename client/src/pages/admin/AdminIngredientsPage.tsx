                ...
                <tr key={ing.id} className={`border-b border-gl-pebble ${i % 2 === 0 ? '' : 'bg-gl-petalmist'}`}>
                  ...
                  <td className="px-5 py-3">
                    <span className={`text-xs px-2.5 py-1 rounded-full ${
                      ing.irritation_potential === 'HIGH'   ? 'bg-gl-danger-light text-gl-danger' :
                      ing.irritation_potential === 'MEDIUM' ? 'bg-[#F5EDD4] text-[#6B540A]' :
                  ...
                  <td className="px-5 py-3">
                    <span className={`text-xs px-2.5 py-1 rounded-full ${ing.is_active ? 'bg-gl-moss text-white' : 'bg-gl-petalmist text-gl-stone'}`}>
